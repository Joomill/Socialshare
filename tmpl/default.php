	...
	<ul class="socialshare-buttons clearfix">
		...
		<?php if ($displayLinkedin) : ?>
			<li class="socialshare-linkedin">
				<a href="http://www.linkedin.com/shareArticle?url=<?php echo urlencode($itemURL); ?>&amp;title=<?php echo urlencode($article->title); ?>&amp;summary=<?php echo urlencode(HTMLHelper::_('string.truncate', $article->text, 50, false, false)); ?>" target="<?php echo $target; ?>">
                    <span class="socialshare-icon <?php echo $displayPlatformIcon; ?>">
