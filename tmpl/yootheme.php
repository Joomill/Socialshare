...
<div class="socialshare-uikit-container <?php if ($view == 'article') { echo $stickyShare; } ?> uk-padding-small <?php echo $yoothemeBackground; ?> <?php echo $yoothemeTextColor; ?> <?php echo $yoothemeAlign; ?>">
            ...
            <?php if ($data['enabled']): ?>
                <li class="el-item">
                    <a href="<?php echo $data['url']; ?>"
                       ...
                       class="<?php echo $yoothemeStyle; ?>" uk-icon="<?php echo strtolower(str_ireplace('email', 'mail', $data['text'])); ?>">
                    </a>
                </li>
            <?php endif; ?>
        <?php endforeach; ?>
